![Build Status](https://github.com/cairocoder01/disciple-tools-team-module/actions/workflows/ci.yml/badge.svg?branch=master)
...
#### Framework
 ...
 1. Disciple.Tools Theme presence check. ```disciple_tools_team_module()```
